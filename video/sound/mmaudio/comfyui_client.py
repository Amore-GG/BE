    ...
    def update_mmaudio_workflow(
        ...
        for node_id, node in workflow.items():
            ...
            if class_type == "VHS_LoadVideo":
                ...
                print(f"[Workflow] 노드 {node_id} (VHS_LoadVideo): {video_filename}, force_rate={force_rate}")
            
            # VHS_VideoCombine 노드 (노드 97)
            elif class_type == "VHS_VideoCombine":
                print(f"[Workflow] 노드 {node_id} (VHS_VideoCombine): 출력 설정 확인됨")
